...
Our parallelization of the brute force search did not lead to performance gains, likely because out optimized implementation was very performant already and not easy to parallelize so our parallelization follows the original implementation.
```{r}
# optimized implementation
microbenchmark(brute_force_knapsack(x = knapsack_objects[1:16,], W = 3500))
# initial implementation
